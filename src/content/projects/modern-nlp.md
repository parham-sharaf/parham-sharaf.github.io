...
<div style="display: grid; grid-template-columns: 1fr 1fr; gap: 0.75rem; margin: 1.5rem 0; align-items: start;">
  ...
  <img src="/images/cs288_pp_attachment.jpg" alt="PP attachment ambiguity: 'They saw the monkey with the glasses' — two valid parse trees, model picks wrong noun attachment" style="margin: 0; border-radius: 0.5rem; width: 100%;" />
</div>

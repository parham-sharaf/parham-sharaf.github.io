...
<div style="display: grid; grid-template-columns: 1fr 1fr; gap: 0.75rem; margin: 1.5rem 0;">
  <img src="/images/cs61cpu-control.png" alt="Control ROM: 64x16 lookup table mapping instruction bits to control signals" style="margin: 0; border-radius: 0.5rem; width: 100%;" />
...
- **Control hazards:** Branch condition is resolved in Stage 1 (BranchComp runs in the fetch/decode stage), so the branch target is known before Stage 2 executes, with no branch misprediction penalty.
